...
import com.taksolutions.uasready.domain.engine.AssessmentEngine
import com.taksolutions.uasready.domain.model.Aircraft
import com.taksolutions.uasready.domain.model.AircraftLimitations
...
class DataLayerTest {
    ...
    fun testMainViewModelConstructorReflection() {
        val constructor = com.taksolutions.uasready.ui.viewmodel.MainViewModel::class.java.getConstructor(android.app.Application::class.java)
    ...
    fun testTerrainObstructionProfileFromSectorAngles() {
        ...
        val profile = com.taksolutions.uasready.domain.model.TerrainObstructionProfile.fromSectorAngles(
        ...
        val gnssWithCanyon = com.taksolutions.uasready.domain.model.GnssEstimation.estimate(
            latitude = 34.0,
            elevationFt = 1100.0,
            kpIndex = 2.0,
